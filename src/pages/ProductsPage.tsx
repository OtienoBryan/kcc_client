...
import { Pencil, Trash2, Plus, Package, DollarSign, Image as ImageIcon, Filter, Search, Grid, List, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight, Tag } from 'lucide-react';
                ...
                onSubmit={async e => {
                  ...
                  try {
                    ...
                    if (res.data.success) {
                      ...
                      setAddForm({ product_name: '', product_code: '', category_id: '', brand_id: '', cost_price: '', image: null });
                    } else {
