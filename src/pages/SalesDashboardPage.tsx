...
const SalesDashboardPage: React.FC = () => {
  ...
  const navigationItems = useMemo(() => [
    ...
    { to: '/clients-list', label: 'Outlets', icon: <UsersIcon className="h-3.5 w-3.5" />, color: 'bg-pink-100 text-pink-700 hover:bg-pink-200' },
    ...
    { to: '/visits', label: 'Visits Reports', icon: <MapPinIcon className="h-3.5 w-3.5" />, color: 'bg-teal-100 text-teal-700 hover:bg-teal-200' },
    { to: '/financial/customer-orders', label: 'Orders Report', icon: <BarChart3Icon className="h-3.5 w-3.5" />, color: 'bg-red-100 text-red-700 hover:bg-red-200'},
    ...
    //{ to: '/dashboard/reports/outlet-visits-summary', label: 'Outlet Visits Summary', icon: <MapPinIcon className="h-3.5 w-3.5" />, color: 'bg-lime-100 text-lime-700 hover:bg-lime-200' },
