...
const SalesRepsPage: React.FC = () => {
  ...
  const filteredSalesReps = salesReps.filter(rep => {
    ...
    const teamLeaderMatch = selectedTeamLeader
      ? (salesRepTeamLeaders[rep.id] || []).some(tl => String(tl.id) === selectedTeamLeader)
      : true;
                    ...
                    <tr key={rep.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-3 py-2 whitespace-nowrap">
                        <div className="flex flex-wrap gap-1">
                          ...
                          {(rep.role?.toLowerCase()?.trim() || 'sales rep') !== 'team leader' && (
                            <button
                              onClick={() => {
